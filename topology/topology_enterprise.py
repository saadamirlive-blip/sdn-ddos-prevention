...
class FastOVSSwitch(OVSSwitch):
    """Custom OVS Switch that bypasses blocking connection loops for instant startup"""
...
def run_enterprise_simulation():
    ...
    # Standard Mininet initialization with RemoteController on port 6653 (instant non-blocking)
